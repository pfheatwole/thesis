...
p1 = points1["r_P2O"]
p2 = points2["r_P2O"]
ax.plot(p1.T[1], p1.T[0], c="orange", lw=0.75)
ax.plot(p2.T[1], p2.T[0], c="red", lw=0.75)
ax.plot([p1.T[1][-1]], [p1.T[0][-1]], c="orange", marker=".", markersize=10)
ax.plot([p2.T[1][-1]], [p2.T[0][-1]], c="red", marker=".", markersize=10)
ax.set_aspect("equal")
labels = [
    "Variable Reynolds, with apparent mass",
    "Fixed Reynolds (2e6), without apparent mass",
